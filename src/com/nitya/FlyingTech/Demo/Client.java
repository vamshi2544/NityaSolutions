 ...
 * Used to call employee class and give details of employee.
 ...
 * @see emp1.getsalary
 */
System.out.println("Firstname is "+emp1.getFirstname()+"  emp_id is "+emp1.getEmp_id()
 ...
 * @see emp2.getsalary
 */
System.out.println("Firstname is "+emp2.getFirstname()+"  emp_id is "+emp2.getEmp_id()
 ...
 * @see emp3.getsalary
 */
System.out.println("Firstname is "+emp3.getFirstname()+"  emp_id is "+emp3.getEmp_id()
		+"  salary is "+ emp3.getSalary());
/**
 ...
 * @see emp4.getsalary
 */
System.out.println("Firstname is "+emp4.getFirstname()+"  emp_id is "+emp4.getEmp_id()
		+"  salary is "+ emp4.getSalary());
